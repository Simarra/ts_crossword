import { GridBrut, GridEasy } from './grid';
...
export function generate_crossword_using_easy_mode(word_list: Array<string>, description_list: Array<string>, nb_rows: number, nb_cols: number): GridEasy{
    // Generate an array using words, descriptions, and cols and cell numbers.
  let words = new WordListDescr(word_list, description_list);
  let grid = new GridBrut(nb_rows, nb_cols, words);
  return grid;
